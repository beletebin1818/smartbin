...
function tracePrizeUpdate(source, gameId, oldPrize, newPrize, extra = '') {
  console.log(`[PRIZE TRACE] ${new Date().toISOString()} | ${source} | Game #${gameId} | oldPrize=${oldPrize} | newPrize=${newPrize}${extra ? ` | ${extra}` : ''}`);
}
